/* pkgreg marketing homepage — progressive enhancement only. With JS off the
...
(function () {
  ...
  var BEAT = [
    { title: "repeat downloads, repeated cost",          k: "same package fetched" },
    { title: "one shared cache, close to every build",   k: "repeat requests" },
    { title: "checkpoint exactly what you have",         k: "versioned cache" },
    { title: "cached packages, ready offline",           k: "offline cache" }
  ];
  ...
  function render() {
    ...
    if (statusT) {
      statusT.textContent =
        ...
        : act === 4 ? (t < 0.5 ? "offline · the delta is in transit"
                     : t < 0.72 ? "offline · importing the checkpoint"
                     : "offline · serving cached requests")
        : "connected";
    }
  ...
  function singleFlight() {
    ...
    if (corridor() > 130) {
      ...
      tag.textContent = "two machines asking · one download";
