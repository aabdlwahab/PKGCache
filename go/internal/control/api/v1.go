...
func (a *API) v1Routes() {
	...
	a.route("GET /api/v1/local/migration", a.getMigration)
	a.route("POST /api/v1/local/migration/plan", a.planMigration)
	a.route("POST /api/v1/local/migration", a.startMigration)
	a.route("DELETE /api/v1/local/migration", a.acknowledgeMigration)
	a.route("GET /api/v1/local/share", a.getShare)
	a.route("PUT /api/v1/local/share", a.putShare)
	a.route("DELETE /api/v1/local/share", a.deleteShare)
	a.route("POST /api/v1/local/reach", a.reachLocalPeer)
